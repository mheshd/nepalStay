...
export const rooms = [
  {
    ...
    description: 'Wake up to sweeping mountain views, warm wood interiors, and a private balcony above the valley.',
    details:
    ...
    features: ['King bed', 'Private balcony', 'Breakfast included', 'Mountain panorama'],
  },
  {
    ...
    description: 'A calm city escape with handcrafted details, soft linens, and easy access to cultural landmarks.',
    details:
  ...
  },
  {
    ...
    description: 'Relax near Pokhara with spacious comfort, fresh breakfasts, and tranquil views after every adventure.',
    details:
    ...
    features: ['Terrace seating', 'Fresh breakfast', 'Tour support', 'Peaceful location'],
  },
]
...
export const services = [
  {
    ...
    description: 'Reliable high-speed internet for planning trips, remote work, and staying connected.',
    detail:
  ...
  },
  {
    ...
    description: 'Cool off after sightseeing with peaceful pool areas at selected partner stays.',
    detail:
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75c1.5 0 1.5-1.5 3-1.5s1.5 1.5 3 1.5 1.5-1.5 3-1.5 1.5 1.5 3 1.5 1.5-1.5 3-1.5 1.5 1.5 3 1.5M2.25 21c1.5 0 1.5-1.5 3-1.5s1.5 1.5 3 1.5 1.5-1.5 3-1.5 1.5 1.5 3 1.5 1.5-1.5 3-1.5 1.5 1.5 3 1.5M7.5 15.75V4.5a2.25 2.25 0 0 1 4.5 0v1.875M12 9H7.5" />
    ),
  },
  {
    slug: 'restaurant',
    ...
    description: 'Enjoy Nepali flavors, warm breakfasts, and fresh local ingredients.',
    detail:
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18m-5.25-18v6A2.25 2.25 0 0 0 9 11.25h3m5.25-8.25v18M15 3v7.5a2.25 2.25 0 0 0 2.25 2.25h0" />
    ),
  },
  {
    slug: 'spa',
    ...
    description: 'Restore your body with calm treatments after long walks and high-altitude travel.',
    detail:
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21c-3.866 0-7-3.134-7-7 0-2.625 1.447-4.914 3.586-6.111A7.48 7.48 0 0 1 12 3a7.48 7.48 0 0 1 3.414 4.889A6.993 6.993 0 0 1 19 14c0 3.866-3.134 7-7 7Zm0 0c0-4.5-3-7.5-7-7.5m7 7.5c0-4.5 3-7.5 7-7.5" />
    ),
  },
  {
    slug: 'mountain-view',
    ...
    description: 'Choose rooms and terraces with unforgettable views of Nepal landscapes.',
    detail:
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 20.25 7.5-13.5 4.5 8.25 2.25-3.75 5.25 9H2.25Zm6.75-7.5 1.5-2.25 1.5 2.25" />
    ),
  },
  {
    slug: 'free-parking',
    ...
    description: 'Easy parking options for road trips, private transfers, and family travel.',
    detail:
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 21V3h6a4.5 4.5 0 0 1 0 9h-6m0 0h6" />
    ),
  },
]
...
export const testimonials = [
  {
    ...
    review: 'NepalStay arranged a flawless mountain escape. The room, view, and hospitality were even better than the photos.',
  },
  {
    name: 'Maya Chen',
    avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=160&q=80',
    review: 'Beautiful design, kind staff, and thoughtful booking support. It made our first Nepal trip feel effortless.',
  },
  {
    name: 'Liam Carter',
    avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=160&q=80',
    review: 'From Kathmandu to Pokhara, every stay felt curated. I would book with NepalStay again in a heartbeat.',
  },
]
