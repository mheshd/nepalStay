      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center ">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-bold text-stone-950 sm:text-4xl">
            Plan Your Nepal Escape
          </h2>
          <p className="mt-5 text-lg leading-8 text-stone-600">
            Tell us your dates and travel style. Our team will help match you
            with the right stay, from quiet resorts to adventure-ready lodges.
          </p>
