...
export default function RoomCard({ room }) {
  return (
    <article
      className="group overflow-hidden rounded-lg bg-white shadow-lg shadow-stone-200/70 transition duration-300 
    ...
    >
      ...
      <div className="p-6">
        ...
        <p className="mt-4 min-h-24 leading-7 text-stone-600">
          {room.description}
        </p>
        <Link
          to={`/rooms/${room.slug}`}
